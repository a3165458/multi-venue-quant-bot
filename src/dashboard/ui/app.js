...
(function() {
    ...
    const i18nStrings = {
        en: {
            ...
            mq_flatten_ioc_secs: 'ALO flatten refresh after (s)',
            ...
            mq_flatten_only: 'Flatten-only after fill (ALO only)',
        ...
        cn: {
            ...
            mq_flatten_ioc_secs: 'ALO 平仓撤挂等待 (秒)',
    ...
    const MQ_PARAMS = [
        ...
        { key: 'flatten_ioc_secs', min: 1, max: 300, step: 1, def: 90 },
